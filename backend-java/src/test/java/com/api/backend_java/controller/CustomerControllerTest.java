...
class CustomerControllerTest {
	...
	void createCase1() throws Exception {
		...
		mockMvc.perform(post("/customers/create").contentType(MediaType.APPLICATION_JSON)
	...
	void createCase2() throws Exception {
		...
		mockMvc.perform(post("/customers/create").contentType(MediaType.APPLICATION_JSON)
				...
				.andExpect(jsonPath("$.message").value("cpf, rg, email, contact or password exists")).andDo(print())
				.andReturn();
	}
	...
	void loginCase1() throws Exception {
		...
		mockMvc.perform(post("/customers/login").contentType(MediaType.APPLICATION_JSON)
	...
	void loginCase2() throws Exception {
		...
		mockMvc.perform(post("/customers/login").contentType(MediaType.APPLICATION_JSON)
				...
				.andExpect(jsonPath("$.message").value("customer not found")).andDo(print()).andReturn();
	}
